 ...
 * glues together all the words, including "WUB", in one
...
const songDecoderRegex = song => song.replace(/(WUB)+/g," ").trim()
...
describe('song', function() {
  describe('#songDecoder()', function() {
    it('should return a string', function() {
      assert.equal(songDecoder("WUBWEWUBAREWUBWUBTHEWUBCHAMPIONSWUBMYWUBFRIENDWUB"), "WE ARE THE CHAMPIONS MY FRIEND")
